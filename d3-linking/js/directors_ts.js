...
d3.csv("data/director_sum_d3.csv",function(data) {
...
////  Bar Chart /////////////////////////////////
    ...
    barchartsvg.append("text")
            .attr("class", "x label")
            .text("Aggregate gross return on investment on movies made by each director")
            .attr("x", 400)
            .attr("y",595)
            .attr("text-anchor", "middle")
            .attr("font-family", "sans-serif")
 ...
 ///// Time Series Chart /////
    ...
    var text_pos = data.map(function(d,i){if (counts[i]> 7 ){return "end"} else {return "start"} });
    var formatPercent = d3.format(",.0%");
    ...
    var x_pos = data.map(function(d,i){if(counts[i] >7){return -0.5} else {return +0.5}})
    //console.log(titles)
    ...
    timeseriessvg.append("text")
            .attr("class", "x label")
            .text("Number of movies made by each director")
            .attr("x", 480)
            .attr("y",595)
            .attr("text-anchor", "middle")
            .attr("font-family", "sans-serif")
